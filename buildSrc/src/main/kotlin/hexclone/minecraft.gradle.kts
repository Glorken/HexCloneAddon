...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexclone.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexclone-common-common-refmap.json
        // fixed:   hexclone-common.refmap.json
