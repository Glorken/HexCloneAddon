...
abstract class HexCloneModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexCloneModDependenciesExtension>("hexcloneModDependencies")
